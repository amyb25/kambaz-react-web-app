...
export default function AddAssignmentEditor() {
  ...
  // Fetch existing assignment if available (for editing purposes)
  useEffect(() => {
     const assignment = assignments.find((a: any) => a.course === cid); // Find matching assignment
     if (assignment) {
  ...
  const handleAddAssignment = () => {
     ...
     dispatch(addAssignment(newAssignment)); // Dispatch the addAssignment action
   };
        ...
        <div>
            <div id="wd-assignments-editor" className="bring-over">
                ...
                <FormControl 
                    as="textarea" 
                    rows={14} 
                    placeholder={assignmentDes}  
                    onChange={(e) => setAssignmentDes(e.target.value)}
                    value={assignmentDes}  // Make this mutable with onChange
                />
                <table>
                    <br />
                    <br />
                    <tr>
                        ...
                        <td>
                            <FormControl 
                                ...
                                onChange={(e) => setAssignmentPoints(e.target.value)} // onChange for mutable state
                            />
                        </td>
                    </tr>
                    <br />
                    <tr>
                        ...
                        <td>
                            <FormSelect className="center-box">
                    ...
                    <tr>
                        ...
                        <div className="card move-card h-100">
                            <div className="center-container">
                                <FormSelect className="small-dropdown">
                    ...
                    <div className="card move-card-2 h-100">
                        <br />
                        <td className="center-box-next">
                            <label htmlFor="wd-assign-to">Assign To</label><br />
                            <td className="small-dropdown-2">
                                <FormControl className="small-dropdown-2" type="text" value="Everyone" />
                            </td>
                        </td>
                        <tr>
                            <td className="center-box-next">
                                ...
                                <div className="small-dropdown-2">
                                    <FormControl 
                                        value={dueDate} 
                                        className="small-dropdown-2" 
                                        type="date" 
