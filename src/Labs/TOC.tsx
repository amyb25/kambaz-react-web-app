...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <Nav.Item>
        <Nav.Link href="https://github.com/amyb25">My GitHub</Nav.Link>
        <Nav.Link href="https://kambaz-node-server-app-3zei.onrender.com">Render Link</Nav.Link>
      </Nav.Item>
    </Nav>
 );}
